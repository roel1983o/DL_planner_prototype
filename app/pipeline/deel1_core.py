...
# We execute the original notebook code in an isolated namespace and set the expected path variables.
...
def run_deel1(*, templates_path: str, beslispad_spread_path: str, beslispad_ep_path: str,
    ...
    ns: Dict[str, Any] = {}
    # Inject required variables (names as used in the notebook)
    ...
    # Run notebook code
    code = r"""def copy_storylist(wb, src_name, dst_name):
